...
//        // wenn nah genug
       // for (int i = 0; this.percept.getWumpusStenchRadar()[i][0] != 0; i++) {
           // System.out.println("Dis: [" + this.percept.getWumpusStenchRadar()[i][0] + "]: " + this.percept.getWumpusStenchRadar()[i][1]);
        //}
...
//        }
    ...
    public IAction chooseAction() {
        ...
        nextAction = runner.getNextAction();
